...
import HorizontalLinearStepperNormalCourier from "./MailRegistration/NormalCourierStepper";
const NormalCourier = () => {
  ...
  return (
    <>
      <Breadcrumbs aria-label="breadcrumb">
        ...
        />
        <StyledBreadcrumb component="a" href="#" label="Normal Courier Post" />
        {/* <StyledBreadcrumb
      label="Accessories"
    ...
    /> */}
      ...
      >
        ...
        >
          ...
          <div style={{ width: "90%" }}>
            <HorizontalLinearStepperNormalCourier />
          </div>
        </Box>
      </Box>
    </>
